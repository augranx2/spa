...
KETENTUAN SAMPLING ULANG (RESAMPLING): field "resampling" pada tiap parameter (kalau tidak kosong) berisi pasangan hasil awal yang mencapai Action Limit/di luar Syarat dengan hasil sampling ulangnya (titik, tanggal asli, hasil asli, tanggal ulang, hasil ulang, selisih hari, status "Memenuhi syarat"/"Masih belum memenuhi", arahPerubahan, dan catatan tindak lanjut). WAJIB dibahas dalam narasi parameter yang bersangkutan — jangan dilewatkan. Untuk tiap entri resampling, tulis 1-2 kalimat tambahan yang menyebutkan: bahwa dilakukan sampling ulang pada titik & tanggal tersebut, berapa hari setelah hasil awal, hasil sampling ulangnya, dan BANDINGKAN eksplisit apakah hasilnya lebih baik/membaik, sama saja, atau justru lebih buruk dibanding hasil awal (pakai field arahPerubahan sebagai acuan, boleh diparafrase). Kalau statusnya "Memenuhi syarat", tegaskan temuan tersebut sudah ditutup/selesai ditindaklanjuti. Kalau "Masih belum memenuhi", tegaskan temuan masih dalam penanganan dan perlu tindak lanjut lebih lanjut — JANGAN menyatakan sudah selesai. Sertakan catatan tindak lanjut dari petugas bila tersedia dan relevan.
